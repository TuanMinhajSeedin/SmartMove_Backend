...
# Neo4j connection details (override via env vars to point at Fare DB)
NEO4J_URI = os.getenv("NEO4J_URI", "bolt://localhost:7687")
NEO4J_USER = os.getenv("NEO4J_USER", "neo4j")
NEO4J_PASSWORD = os.getenv("NEO4J_PASSWORD", "20665130@mM")
# Target database name (multi-database setups). Defaults to "fare".
NEO4J_DATABASE = os.getenv("NEO4J_DATABASE", "fare")
...
def ingest_all_routes_with_normalization():
    ...
    final_tuples = []
    folder = "artifacts/public_transport_data/translated_data/Fares/AC Fares (Effect from 2024-10-02)"
    ...
    # Connection details (defaults can be overridden via env to target Fare DB)
